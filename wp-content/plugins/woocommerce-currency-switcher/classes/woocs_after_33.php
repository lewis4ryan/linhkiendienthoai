...
//*** checking and assigning data
    ...
    public function plugin_action_links($links) {
        return array_merge(array(
            ...
            '<a target="_blank" href="' . esc_url('https://currency-switcher.com/documentation/') . '">' . esc_html__('Documentation', 'woocommerce-currency-switcher') . '</a>'
                ), $links);
    ...
    function woocs_alert() {
        if (isset($_GET['tab']) AND $_GET['tab'] == 'woocs') {
            ...
            <div class="notice notice-warning is-dismissible" id="woocs_alert_notice" data-nonce="<?php echo json_encode(wp_create_nonce('woocs_dissmiss_alert')) ?>">
                ...
                <hr />
                <p class="plugin-card-woocommerce-currency-switcher">
                    If your shop need WooCommerce Products Filter - you can find it <a href="https://products-filter.com/" target="_blank">here</a>. If your need WooCommerce BulkEditor - you can find it <a href="https://bulk-editor.com/" target="_blank">here</a>
                </p>
            </div>
