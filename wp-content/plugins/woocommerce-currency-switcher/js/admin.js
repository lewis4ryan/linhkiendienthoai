...
jQuery(function ($) {
    ...
    jQuery('#woocs_add_currency').life('click', function () {
        ...
        alert('Hello! Free version of WOOCS has all its features unlocked, BUT can operate only with 2 any currencies. If your shop need more currencies please review Premium version of the plugin (see links below). Thank you!');
