=== WooCommerce Currency Switcher (WOOCS) - Multi Currency and Multi Pay for WooCommerce ===
...
WooCommerce Currency Switcher is available as shortcode **[[woocs]](https://currency-switcher.com/shortcode/woocs/)** so as the widget.
