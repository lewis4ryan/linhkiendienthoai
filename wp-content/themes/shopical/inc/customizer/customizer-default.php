...
function shopical_get_default_theme_options() {
    ...
    $defaults['top_categories_section_title'] = 'Danh mục sản phẩm';
    ...
    $defaults['store_variable_add_to_cart_text']    = 'Đặt hàng';
    $defaults['store_grouped_add_to_cart_text']    = 'Đặt hàng';
    $defaults['store_external_add_to_cart_text']    = 'Xem nhiều hơn';

    $defaults['store_product_search_autocomplete']    = 'yes';
    $defaults['store_product_search_placeholder']    = 'Tìm kiếm sản phẩm...';
    $defaults['store_product_search_category_placeholder']    = 'Loại sản phẩm';
