...
if (!function_exists('shopical_display_yith_quickview_loop')) {
    ...
    function shopical_display_yith_quickview_loop()
    {
        ...
        if ($product_id) {
            ...
            $button .= '<a href="#" class="button yith-wcqv-button" data-product_id="' . $product_id . '"><div data-toggle="tooltip" data-placement="top" title="Xem nhanh"><i class="fa fa-search" aria-hidden="true"></i></div></a>';
        }
        echo $button;
        echo '</div>';
